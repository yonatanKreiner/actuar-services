...
const calculateAnnuities = async (deposits) => {
    const results = deposits.map(async deposit => {
        ...
        const depositeFreeCompensation = deposit.depositeCompensation - yearlyAnnuity.compensationMax > 0 ? deposit.depositeCompensation - yearlyAnnuity.compensationMax : 0; 
